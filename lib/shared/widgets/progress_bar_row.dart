...
// Same bar pattern everywhere for skill/list progress so “this is progress” is
// recognisable without extra chart libs (see progress_ring.dart for single-metric).
